...
def main(mal_prop, num_std, defense, dataset, backdoor_attack, alpha, learning_rate=1, fading_rate=10000, momentum=0.9, batch_size=83, users_count=100, epochs=150, mal_epochs = 30, loss='MSE', output=None):
    if output:
        def my_print(s, end='\n'):
...
if __name__ == "__main__":
    ...
    parser.add_argument('-m', '--mal-prop', default=0, type=float,
    ...
    parser.add_argument('-d', '--defense', default='TrimmedMean', choices=['NoDefense', 'Bulyan', 'TrimmedMean', 'Krum'])

    parser.add_argument('-s', '--dataset', default='CIFAR10', choices=['MNIST', 'CIFAR10'])
    ...
    parser.add_argument('-n', '--users-count', default=51, type=int,
